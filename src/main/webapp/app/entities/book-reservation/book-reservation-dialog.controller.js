(function() {
    ...
    BookReservationDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'BookReservation', 'Book', 'User'];

    function BookReservationDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, BookReservation, Book, User) {
        var vm = this;
