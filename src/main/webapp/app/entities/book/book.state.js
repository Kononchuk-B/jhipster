        ...
        $stateProvider
            .state('book', {
                ...
                data: {
                    ...
                    pageTitle: 'libSupportApp.book.home.title'
                },
                views: {
                    'content@': {
            ...
            .state('book-detail', {
                ...
                data: {
                    authorities: ['ROLE_USER'],
                    pageTitle: 'libSupportApp.book.detail.title'
                },
                views: {
                    'content@': {
            ...
            .state('my-book', {
                ...
                data: {
                    authorities: ['ROLE_USER'],
                    pageTitle: 'libSupportApp.book.home.user-title'
                },
                views: {
                    'content@': {
                        templateUrl: 'app/entities/book/user-books.html',
