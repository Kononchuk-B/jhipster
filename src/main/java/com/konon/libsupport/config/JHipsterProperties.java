...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "LibSupport@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "LibSupport API";

        private String description = "LibSupport API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "LibSupport";
