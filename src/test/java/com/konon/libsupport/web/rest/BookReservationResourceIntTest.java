...
public class BookReservationResourceIntTest {
    ...
    public void createBookReservation() throws Exception {
        ...
        restBookReservationMockMvc.perform(post("/api/book-reservations")
            ...
            .content(TestUtil.convertObjectToJsonBytes(bookReservationDTO)))
    ...
    public void createBookReservationWithExistingId() throws Exception {
        ...
        BookReservationDTO existingBookReservationDTO = bookReservationMapper.bookReservationToBookReservationDTO(existingBookReservation);

        // An entity with an existing ID cannot be created, so this API call must fail
        restBookReservationMockMvc.perform(post("/api/book-reservations")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingBookReservationDTO)))
    ...
    public void updateBookReservation() throws Exception {
        ...
        BookReservationDTO bookReservationDTO = bookReservationMapper.bookReservationToBookReservationDTO(updatedBookReservation);
